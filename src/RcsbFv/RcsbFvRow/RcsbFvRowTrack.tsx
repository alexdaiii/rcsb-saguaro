...
export class RcsbFvRowTrack extends React.Component<
  RcsbFvRowTrackInterface,
  RcsbFvRowTrackState
> {
  ...
  private configStyle(): React.CSSProperties {
    ...
    if (typeof this.props.rowTrackConfigData.trackWidth === "number") {
      width =
        this.props.rowTrackConfigData.trackWidth +
  ...
  private borderStyle(): React.CSSProperties {
    ...
    style.borderColor =
      this.props.rowTrackConfigData.borderColor ??
      RcsbFvDefaultConfigValues.borderColor;
    if (this.props.rowTrackConfigData.displayType != RcsbFvDisplayTypes.AXIS) {
      style.borderLeft =
        this.props.rowTrackConfigData.borderWidth ??
        RcsbFvDefaultConfigValues.borderWidth + "px solid #DDD";
      style.borderRight =
        this.props.rowTrackConfigData.borderWidth ??
        RcsbFvDefaultConfigValues.borderWidth + "px solid #DDD";
    }
