...
export class RcsbFvRow extends React.Component<
  RcsbFvRowInterface,
  RcsbFvRowState
> {
  ...
  render() {
    const classNames: string =
      this.props.rowConfigData.displayType === RcsbFvDisplayTypes.AXIS
        ? classes.rcsbFvRow + " " + classes.rcsbFvRowAxis
        : classes.rcsbFvRow;
    return (
      <CSSTransition
      ...
      >
        <div
          ...
          className={
            classNames +
            (this.state.titleGlow && this.state.display
              ? " " + classes.rcsbFvGlowTitle
              : "")
          }
          style={this.configStyle()}
        >
          <RcsbFvRowTitle
            data={this.props.rowConfigData}
            rowTitleHeight={this.state.rowHeight}
            isGlowing={this.state.titleGlow}
            {...this.props.rowConfigData.externalRowTitle
  ...
  configStyle(): React.CSSProperties {
    ...
    if (typeof this.props.rowConfigData.trackWidth === "number") {
      trackWidth =
        this.props.rowConfigData.trackWidth +
        2 * RcsbFvDefaultConfigValues.borderWidth;
    }
    return {
      width:
        titleWidth + trackWidth + RcsbFvDefaultConfigValues.titleAndTrackSpace,
