...
export interface RcsbFvRowMarkPublicInterface<T>
  extends RcsbFvRowMarkCallbackInterface {
  externalRowMark?: {
...
export class RcsbFvRowMark<T> extends React.Component<
  RcsbFvRowMarkInterface<T>,
  {}
> {
        ...
        <div>
          {this.props.externalRowMark ? (
            <this.props.externalRowMark.component
              ...
              {...this.props.externalRowMark.props}
            />
          ) : (
            <div
