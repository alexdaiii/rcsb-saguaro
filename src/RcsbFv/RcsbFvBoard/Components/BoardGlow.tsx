...
export class BoardGlow extends React.Component<BoardGlowInterface> {
  ...
  render() {
    return (
      <div
        id={this.props.boardId + RcsbFvDOMConstants.GLOW_DOM_ID_PREFIX}
        className={classes.rcsbNoGlow}
      >
        <div />
      </div>
    );
