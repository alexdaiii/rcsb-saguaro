...
export class RcsbFvContextManager {
  private readonly conditionalFlag: Map<CONDITIONAL_FLAG, boolean> = new Map<
    CONDITIONAL_FLAG,
    boolean
  >();
  private readonly subject: Subject<RcsbFvContextManagerType> =
    new Subject<RcsbFvContextManagerType>();
