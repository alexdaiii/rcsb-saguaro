...
export class RcsbFvTooltipManager {
  ...
  constructor(boardId: string, tooltip: RcsbFvTooltipInterface) {
    ...
    const tooltipDiv: HTMLDivElement | null = document.querySelector(
      "#" + this.boardId + RcsbFvDOMConstants.TOOLTIP_DOM_ID_PREFIX,
    );
    if (tooltipDiv == null) throw "Tooltip DOM element not found";
    this.tooltipDiv = tooltipDiv;
    const tooltipDescriptionDiv: HTMLDivElement | null = document.querySelector(
      "#" + this.boardId + RcsbFvDOMConstants.TOOLTIP_DESCRIPTION_DOM_ID_PREFIX,
    );
    if (tooltipDescriptionDiv == null) throw "Tooltip DOM element not found";
