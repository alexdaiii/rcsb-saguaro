...
export class RcsbDataManager {
   ...
   * */
  public static joinTrackDataArray(
    dataList: Array<RcsbFvTrackData>,
  ): RcsbFvTrackData {
   ...
   * */
  public static getNonOverlappingData(
  ...
  private static doOverlap(
    a: RcsbFvTrackDataElementInterface,
    b: RcsbFvTrackDataElementInterface,
  ): boolean {
    if (
      typeof a.begin === "number" &&
      typeof b.begin === "number" &&
      typeof a.end === "number" &&
      typeof b.end === "number"
    ) {
      if (a.end < b.begin || b.end < a.begin) return false;
