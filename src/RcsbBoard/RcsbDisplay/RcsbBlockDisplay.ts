...
export class RcsbBlockDisplay extends RcsbAbstractDisplay {
  ...
  private lines: Selection<
    ...
    BaseType,
    undefined
  > = select<SVGGElement, LineDecoratorInterface>(RcsbD3Constants.EMPTY);
  private circles: Selection<
    SVGGElement,
    CircleDecoratorInterface,
    BaseType,
    undefined
  > = select<SVGGElement, CircleDecoratorInterface>(RcsbD3Constants.EMPTY);
  private circleDecorators: Array<CircleDecoratorInterface> =
    new Array<CircleDecoratorInterface>();
  private lineDecorators: Array<LineDecoratorInterface> =
    new Array<LineDecoratorInterface>();
  ...
  protected processData(
    dataElems: RcsbFvTrackData,
  ): RcsbFvTrackData<BlockElementInterface> {
  ...
  protected static dataKey(
    d: RcsbFvTrackDataElementInterface & BlockElementInterface,
  ): string {
    if (d.rectBegin && d.rectEnd) return d.rectBegin + ":" + d.rectEnd;
  ...
  private plotDecorators(
    features: Array<RcsbFvTrackDataElementInterface>,
  ): void {
    const lines: Selection<
      ...
      undefined
    > = this.g
      .selectAll<SVGGElement, LineDecoratorInterface>(
        "." + classes.rcsbDecorator + "_line",
      )
      .data(this.lineDecorators, (l: LineDecoratorInterface) => {
        return l.begin + ":" + l.end;
      });
    const newLines: Selection<
      SVGGElement,
      LineDecoratorInterface,
      BaseType,
      undefined
    > = lines
      .enter()
      .append("g")
      .attr("class", classes.rcsbDecorator)
    ...
    const circles: Selection<
      ...
      undefined
    > = this.g
      .selectAll<SVGGElement, CircleDecoratorInterface>(
        "." + classes.rcsbDecorator + "_circle",
      )
      .data(this.circleDecorators, (c: CircleDecoratorInterface) => {
        return c.position.toString();
      });
    const newCircles: Selection<
      SVGGElement,
      CircleDecoratorInterface,
      BaseType,
      undefined
